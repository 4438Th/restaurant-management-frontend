...
export function TableCard({
  ...
  return (
    <div
      ...
      className="group relative bg-surface-container-lowest hover:bg-surface-container-low border border-outline-variant hover:border-outline rounded-xl p-4 flex flex-col justify-between transition-all duration-200 shadow-sm hover:shadow cursor-pointer"
    >
      ...
      <div className="mt-4 pt-3 border-t border-outline-variant/60 flex items-center justify-between">
        <div className="flex items-center gap-1.5 text-xs text-on-surface-variant">
          ...
          <span>
            Sức chứa:{" "}
            <strong className="text-on-surface">{table.capacity}</strong> người
          </span>
        </div>
